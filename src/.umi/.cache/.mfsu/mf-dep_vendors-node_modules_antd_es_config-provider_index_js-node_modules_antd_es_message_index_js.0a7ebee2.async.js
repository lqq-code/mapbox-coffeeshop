...
function registerTheme(globalPrefixCls, theme) {
  ...
  var fillColor = function fillColor(colorVal, type) {
    ...
    var colorPalettes = (0,_ant_design_colors__WEBPACK_IMPORTED_MODULE_2__.generate)(baseColor.toRgbString());
  ...
  if (theme.primaryColor) {
    ...
    var primaryColors = (0,_ant_design_colors__WEBPACK_IMPORTED_MODULE_2__.generate)(primaryColor.toRgbString()); // Legacy - We should use semantic naming standard
  ...
  if ((0,rc_util_es_Dom_canUseDom__WEBPACK_IMPORTED_MODULE_1__.default)()) {
    ...
    (0,_util_devWarning__WEBPACK_IMPORTED_MODULE_4__.default)(false, 'ConfigProvider', 'SSR do not support dynamic theme with css variables.');
  }
}
...
var LocaleProvider = /*#__PURE__*/function (_React$Component) {
  ...
  function LocaleProvider(props) {
    ...
    (0,_util_devWarning__WEBPACK_IMPORTED_MODULE_8__.default)(props._ANT_MARK__ === ANT_MARK, 'LocaleProvider', '`LocaleProvider` is deprecated. Please use `locale` with `ConfigProvider` instead: http://u.ant.design/locale');
    return _this;
  }
