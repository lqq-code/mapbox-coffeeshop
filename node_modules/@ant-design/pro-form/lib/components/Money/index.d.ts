...
export declare type ProFormMoneyProps = ProFormFieldItemProps<Omit<ProFieldMoneyProps, 'valueType' | 'text'> & InputNumberProps> & {
    customSymbol?: string;
    locale?: string;
...
declare const _default: React.ForwardRefExoticComponent<{
    fieldProps?: (import("../../interface").FieldProps & Omit<import("@ant-design/pro-field").FieldMoneyProps, "valueType" | "text"> & InputNumberProps<string | number>) | undefined;
