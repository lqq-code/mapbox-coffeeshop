...
var QueryFilterContent = function QueryFilterContent(props) {
  ...
  var doms = flatMapItems(items, props.ignoreRules).map(function (item, index) {
    ...
    var colSize = /*#__PURE__*/_react.default.isValidElement(item) ? item === null || item === void 0 ? void 0 : (_item$props3 = item.props) === null || _item$props3 === void 0 ? void 0 : _item$props3.colSize : 1;
    ...
    itemLength += 1;
    var itemKey = /*#__PURE__*/_react.default.isValidElement(item) && (item.key || "".concat((_item$props5 = item.props) === null || _item$props5 === void 0 ? void 0 : _item$props5.name)) || index;
    ...
    var colItem = /*#__PURE__*/_react.default.createElement(_col.default, {
      key: itemKey,
      span: colSpan
    }, itemDom);

    if (split && currentSpan % 24 === 0 && index < itemLength - 1) {
      return [colItem, /*#__PURE__*/_react.default.createElement(_col.default, {
        span: "24",
        key: "line"
  ...
  }, doms, submitter && /*#__PURE__*/_react.default.createElement(_col.default, {
    key: "submitter",
    span: spanSize.span,
    offset: offset,
    style: {
...
var defaultWidth = (0, _proUtils.isBrowser)() ? document.body.clientWidth : 1024;
...
function QueryFilter(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_rcResizeObserver.default, {
  ...
  }, /*#__PURE__*/_react.default.createElement(_BaseForm.BaseForm, (0, _extends2.default)({
    ...
    contentRender: function contentRender(items, renderSubmitter, form) {
      return /*#__PURE__*/_react.default.createElement(QueryFilterContent, {
        spanSize: spanSize,
