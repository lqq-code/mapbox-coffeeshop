...
function createField(Field, config) {
  ...
  var FieldWithContext = function FieldWithContext(props) {
    ...
    var restRef = (0, _proUtils.useLatest)(rest); // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    var isUpdate = (0, _react.useRef)(false);
    var shouldRender = (0, _react.useRef)(true); // onChange触发fieldProps,formItemProps重新执行
    ...
    var fieldContextValue = _react.default.useContext(_FieldContext.default);
    /**
    ...
    var formItemProps = (0, _react.useMemo)(function () {
      return (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({}, fieldContextValue.formItemProps), restFormItemProps), changedProps.formItemProps), rest.formItemProps);
    ...
    var renderFormItem = (0, _react.useCallback)(function () {
    ...
    var fieldPropsStyle = (0, _react.useMemo)(function () {
      var newStyle = (0, _objectSpread2.default)({}, fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.style);
    ...
    [(0, _useJsonComparison.stringify)(fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.style), propsValueType]);
    ...
    var field = (0, _react.useMemo)(function () {
      return /*#__PURE__*/_react.default.createElement(Field // @ts-ignore
      , (0, _extends2.default)({
    ...
    (0, _proUtils.isDeepEqualReact)(prefRest, rest, ['onChange', 'onBlur', 'onFocus', 'record', 'renderFormItem']) ? undefined : {}]); // 使用useMemo包裹避免不必要的re-render

    var FormItem = (0, _react.useMemo)(function () {
      var _otherProps$name, _field$props$allowCle, _field$props, _field$props2;

      return /*#__PURE__*/_react.default.createElement(_components.ProFormItem // 全局的提供一个 tip 功能，可以减少代码量
  ...
  var DependencyWrapper = function DependencyWrapper(props) {
    ...
    return dependencies ? /*#__PURE__*/_react.default.createElement(_components.ProFormDependency, {
      name: dependencies
    }, function (values) {
      return /*#__PURE__*/_react.default.createElement(FieldWithContext, (0, _extends2.default)({
        dependenciesValues: values,
        dependencies: dependencies
      }, props));
    }) : /*#__PURE__*/_react.default.createElement(FieldWithContext, (0, _extends2.default)({
      dependencies: dependencies
    }, props));
  };
