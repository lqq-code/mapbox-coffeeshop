...
var CheckboxList = function CheckboxList(_ref3) {
  ...
  var onCheckTree = (0, _proUtils.useRefFunction)(function (e) {
    ...
    var newSetting = (0, _objectSpread4.default)({}, tempConfig);
    ...
    var columnKeyMap = (0, _objectSpread4.default)((0, _objectSpread4.default)({}, columnsMap), {}, (0, _defineProperty2.default)({}, columnKey, (0, _proUtils.omitUndefined)(newSetting))); // 如果没有值了，直接干掉他

    if (!(0, _proUtils.omitUndefined)(newSetting)) {
  ...
  var listDom = /*#__PURE__*/_react.default.createElement(_tree.default, {
    ...
    titleRender: function titleRender(_node) {
      ...
      return /*#__PURE__*/_react.default.createElement(CheckboxListItem, (0, _extends2.default)({
        className: className
      }, node, {
        columnKey: node.key
      }));
...
function ColumnSetting(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_popover.default, {
    ...
    }, intl.getMessage('tableToolBar.columnDisplay', '列展示')), checkedReset ? /*#__PURE__*/_react.default.createElement("a", {
      onClick: clearClick,
      className: "".concat(className, "-action-rest-button")
    }, intl.getMessage('tableToolBar.reset', '重置')) : null, (props === null || props === void 0 ? void 0 : props.extra) ? /*#__PURE__*/_react.default.createElement(_space.default, {
      size: 12,
      align: "center"
    }, props.extra) : null),
