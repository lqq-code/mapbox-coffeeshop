...
var _excluded = ["onTableChange", "maxLength", "formItemProps", "recordCreatorProps", "rowKey", "controlled", "defaultValue", "onChange"],
...
function EditableTable(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    value.forEach(function (current, index) {
      ...
      (_formRef$current = formRef.current) === null || _formRef$current === void 0 ? void 0 : _formRef$current.setFieldsValue((0, _defineProperty2.default)({}, getRowKey(current, index), current));
        ...
        components: {
          header: {
            wrapper: function wrapper(_ref2) {
              ...
              }, creatorButtonDom), /*#__PURE__*/_react.default.createElement("td", {
                style: {
                  position: 'absolute',
                  left: 0,
                  width: '100%'
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(EditableTableActionContext.Provider, {
    value: actionRef
  ...
  }))), props.name ? /*#__PURE__*/_react.default.createElement(_proForm.ProFormDependency, {
    name: [props.name]
    ...
    props === null || props === void 0 ? void 0 : (_props$editable3 = props.editable) === null || _props$editable3 === void 0 ? void 0 : (_props$editable3$onVa = _props$editable3.onValuesChange) === null || _props$editable3$onVa === void 0 ? void 0 : _props$editable3$onVa.call(_props$editable3, changeItem, list);
    return null;
  }) : null);
}

function FieldEditableTable(props) {
  if (!props.name) return /*#__PURE__*/_react.default.createElement(EditableTable, props);
  return /*#__PURE__*/_react.default.createElement(_form.default.Item, (0, _extends2.default)({
    ...
    name: props.name
  }), /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_rcFieldForm.Field, {
    shouldUpdate: true,
    name: props.name,
    isList: true
  }, function (control) {
    if (control.value === undefined || !Array.isArray(control.value)) return null;
    return /*#__PURE__*/_react.default.createElement(EditableTable, (0, _extends2.default)({}, props, {
      value: control.value,
