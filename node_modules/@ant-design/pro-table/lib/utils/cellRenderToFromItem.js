...
var CellRenderFromItem = /*#__PURE__*/function (_React$Component) {
  (0, _inherits2.default)(CellRenderFromItem, _React$Component);

  var _super = (0, _createSuper2.default)(CellRenderFromItem);

  function CellRenderFromItem() {
    var _this;

    (0, _classCallCheck2.default)(this, CellRenderFromItem);
    ...
    _this.generateFormItem = function () {
      ...
      var text = config.text,
          ...
          _config$rowData = config.rowData,
          rowData = _config$rowData === void 0 ? {} : _config$rowData;
      /** 获取 formItemProps Props */

      var formItemProps = (0, _proUtils.getFieldPropsOrFormItemProps)(columnProps === null || columnProps === void 0 ? void 0 : columnProps.formItemProps, counter.editableForm, (0, _objectSpread2.default)((0, _objectSpread2.default)({
        rowKey: _this.state.rowName,
        rowIndex: config.index
      }, columnProps), {}, {
        isEditable: true
      }));
      var messageVariables = (0, _objectSpread2.default)({
      ...
      var inputDom = /*#__PURE__*/_react.default.createElement(_proForm.ProFormField, (0, _extends2.default)({
        cacheForSwr: true,
        key: config.recordKey || config.index,
        name: _this.state.name // @ts-ignore
        ,
        proFormFieldKey: config.recordKey || config.index,
        ignoreFormItem: true,
        fieldProps: (0, _proUtils.getFieldPropsOrFormItemProps)(columnProps === null || columnProps === void 0 ? void 0 : columnProps.fieldProps, counter === null || counter === void 0 ? void 0 : counter.editableForm, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, columnProps), {}, {
          rowKey: _this.state.rowName,
          rowIndex: config.index,
          isEditable: true
        }))
      ...
      if (!(columnProps === null || columnProps === void 0 ? void 0 : columnProps.renderFormItem)) {
        ...
        var dom = /*#__PURE__*/_react.default.createElement(_proUtils.InlineErrorFormItem, (0, _extends2.default)({
          key: config.recordKey || config.index,
          errorType: "popover",
      ...
      var renderDom = (_columnProps$renderFo = columnProps.renderFormItem) === null || _columnProps$renderFo === void 0 ? void 0 : _columnProps$renderFo.call(columnProps, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, columnProps), {}, {
        index: config.index,
        isEditable: true,
        type: 'table'
      }), {
        defaultRender: function defaultRender() {
          ...
          return /*#__PURE__*/_react.default.createElement(_proUtils.InlineErrorFormItem, (0, _extends2.default)({
            key: config.recordKey || config.index,
            errorType: "popover",
            name: _this.state.name
          }, formItemProps, {
        ...
        record: (0, _objectSpread2.default)((0, _objectSpread2.default)({}, rowData), counter === null || counter === void 0 ? void 0 : (_counter$editableForm = counter.editableForm) === null || _counter$editableForm === void 0 ? void 0 : _counter$editableForm.getFieldValue([config.recordKey || config.index])),
        isEditable: true
  ...
  (0, _createClass2.default)(CellRenderFromItem, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return !(0, _proUtils.isDeepEqualReact)(nextProps.proFieldProps, this.props.proFieldProps, this.functionKeys) || !(0, _proUtils.isDeepEqualReact)(nextProps.config, this.props.config, this.functionKeys) || !(0, _proUtils.isDeepEqualReact)(nextState, this.state);
    }
  }, {
    key: "render",
      ...
      if (typeof (columnProps === null || columnProps === void 0 ? void 0 : columnProps.renderFormItem) === 'function' || typeof (columnProps === null || columnProps === void 0 ? void 0 : columnProps.fieldProps) === 'function' || typeof (columnProps === null || columnProps === void 0 ? void 0 : columnProps.formItemProps) === 'function') {
        return /*#__PURE__*/_react.default.createElement(_form.default.Item, {
          ...
          shouldUpdate: function shouldUpdate(pre, next) {
            return (0, _proUtils.isDeepEqualReact)((0, _get.default)(pre, _this2.state.rowName), (0, _get.default)(next, _this2.state.rowName));
          },
          noStyle: true
        }, function () {
...
function cellRenderToFromItem(config) {
  ...
  if (config.mode !== 'edit') {
    return /*#__PURE__*/_react.default.createElement(_proForm.ProFormField, (0, _extends2.default)({
      mode: "read",
      ignoreFormItem: true,
  ...
  return /*#__PURE__*/_react.default.createElement(CellRenderFromItem, {
