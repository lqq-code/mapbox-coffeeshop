...
function TableRender(props) {
      ...
      onChange: function onChange(changePagination, filters, sorter, extra) {
        ...
        if (Array.isArray(sorter)) {
          var data = sorter.reduce(function (pre, value) {
            return (0, _objectSpread3.default)((0, _objectSpread3.default)({}, pre), {}, (0, _defineProperty2.default)({}, "".concat(value.field), value.order));
          }, {});
  ...
  var baseTableDom = /*#__PURE__*/_react.default.createElement(_table.default, (0, _extends2.default)({}, getTableProps(), {
    rowKey: rowKey
  }));
  /** 自定义的 render */
  ...
  var tableContentDom = (0, _react.useMemo)(function () {
    if (props.editable && !props.name) {
      ...
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, toolbarDom, alertDom, /*#__PURE__*/_react.default.createElement(_proForm.default, (0, _extends2.default)({
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, toolbarDom, alertDom, tableDom); // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [alertDom, !!props.editable, tableDom, toolbarDom]);
  /** Table 区域的 dom，为了方便 render */

  var tableAreaDom = // cardProps 或者 有了name 就不需要这个padding了，不然会导致不好对其
  cardProps === false || !!props.name ? tableContentDom : /*#__PURE__*/_react.default.createElement(_card.default, (0, _extends2.default)({
...
var ProTable = function ProTable(props) {
  ...
  var fetchData = (0, _react.useMemo)(function () {
    ...
    return /*#__PURE__*/function () {
      var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(pageParams) {
  ...
  var counter = _container.default.useContainer(); // 设置 name 到 store 中，里面用了 ref ，所以不用担心直接 set
  ...
  var editableUtils = (0, _proUtils.useEditableArray)((0, _objectSpread3.default)((0, _objectSpread3.default)({}, props.editable), {}, {
  ...
  return /*#__PURE__*/_react.default.createElement(TableRender, (0, _extends2.default)({}, props, {
    name: isEditorTable,
    rootRef: rootRef,
...
var ProviderWarp = function ProviderWarp(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_container.default.Provider, {
    initialState: props
  }, /*#__PURE__*/_react.default.createElement(_proProvider.ConfigProviderWrap, null, props.ErrorBoundary === false ? /*#__PURE__*/_react.default.createElement(ProTable, (0, _extends2.default)({
    defaultClassName: getPrefixCls('pro-table')
  }, props)) : /*#__PURE__*/_react.default.createElement(ErrorComponent, null, /*#__PURE__*/_react.default.createElement(ProTable, (0, _extends2.default)({
    defaultClassName: getPrefixCls('pro-table')
  }, props)))));
};
