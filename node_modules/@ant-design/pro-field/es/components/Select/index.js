...
import { nanoid, useDeepCompareEffect, useMountMergeState, useDebounceValue } from '@ant-design/pro-utils';
...
export var useFieldFetchData = function useFieldFetchData(props) {
  ...
  var _useSWRImmutable = useSWRImmutable(function () {
    if (!props.request) {
      return null;
    }
    ...
    shouldRetryOnError: false
      ...
      setLocaleData = _useSWRImmutable.mutate,
      isValidating = _useSWRImmutable.isValidating;
