...
function initClass(U) {
    ...
    undefined(prop => makeSetProp(prop, 'setPaintProperty'));
    undefined(prop => makeSetProp(prop, 'setLayoutProperty'));
    undefined(prop => makeGetProp(prop, 'getPaintProperty'));
    undefined(prop => makeGetProp(prop, 'getLayoutProperty'));
