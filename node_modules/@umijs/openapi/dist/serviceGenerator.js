        ...
        return Object.keys(this.apiData)
            ...
            !api.path.includes('${'))
                ...
                try {
                    ...
                    let _a = allParams || {}, { file } = _a, params = tslib_1.__rest(_a, ["file"]); // I dont't know if 'file' is valid parameter, maybe it's safe to remove it
                    ...
                    let functionName = this.config.hook && this.config.hook.customFunctionName
                        ...
                        : newApi.operationId
                            ? this.resolveFunctionName(util_1.stripDot(newApi.operationId), newApi.method)
